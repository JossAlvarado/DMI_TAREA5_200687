...
String textButton = "SI AYER FUERA HOY"; // Texto inicial del botón
...
class _MyButtonState extends State<MyButton> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Tarea5_200687"), // Título de la barra de navegación
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              child: Text("ALBUMNES"), // Texto del botón
            ),
          ],
        ),
      ),
